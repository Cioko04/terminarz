...
public class AkceptujTermin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akceptujtermin);
        setUpViews();
        upClient();
    }
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(terminy.getfEmail().equals(user.getEmail())) {
                                    if (!terminy.getczyOk()) {
                                        ...
                                        items.add(new RecycleItem(R.drawable.ic_manred,
                                                terminy.getwDataStr() + " " + terminy.getwCzas(),
    ...
    private void recycleView(ArrayList<RecycleItem> items){
        ...
        layoutManager = new LinearLayoutManager(AkceptujTermin.this);
        ...
        recyclerAdapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onAddClick(int position) {
                db.collection("Terminy").
                        document(docID.get(position)).update("czyOk", true).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(getApplicationContext(),"Zaakceptowano termin!", Toast.LENGTH_SHORT).show();
                        docID.remove(position);
                    }
                })
                        .addOnFailureListener(new OnFailureListener() {
